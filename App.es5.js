/**
 * Ultra-simple React Native app using only ES5 syntax
 * No arrow functions, no const/let, no destructuring
 */
...
function App() {
  var currentScreen = React.useState('login')[0];
  var setCurrentScreen = React.useState('login')[1];
